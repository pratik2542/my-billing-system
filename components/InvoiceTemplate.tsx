...
export const InvoiceTemplate: React.FC<InvoiceTemplateProps> = ({
  ...
  // When GST is disabled, add one more empty row to fill the space
  const minRows = isGstEnabled ? 9 : 10;
  ...
  return (
    <div id={id} className="bg-white w-[210mm] min-h-[297mm] print:min-h-0 print:h-auto p-4 print:p-2 mx-auto relative font-serif-custom flex flex-col" style={{ color: themeColor }}>
      ...
      <div className="border-2 flex-1 flex flex-col" style={{ borderColor: borderColor }}>
        ...
        <div className="border-t-2" style={{ borderColor: borderColor }}>
          ...
          <div className="flex justify-between items-end p-3 pt-6 border-t-2" style={{ borderColor: borderColor }}>
            ...
            <div className="text-center w-1/3">
              <p className="font-bold mb-4 text-sm">For, {settings.name}</p>
